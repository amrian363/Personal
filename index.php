	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			...
			<div id="home-row-2" class="row clearfix">
				<div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="4"><img src="resources/images/s02.png"></div><span>PROFESSIONAL</span></div>
				...
				<div class="col-12 col-sm-4"><div class="home-hover navigation-slide" data-slide="5"><img src="resources/images/s03.png"></div><span>SUITABLE</span></div>
			</div><!-- /row -->
		</div><!-- /container -->
	</div><!-- /slide1 -->
	...
	<div class="slide story" id="slide-5" data-slide="5">
		<div class="container">
			...
			<div class="row content-row">
				...
				<div class="col-12 col-sm-2"><img src="resources/images/client01.png" alt=""></div>
				<div class="col-12 col-sm-2"><img src="resources/images/client02.png" alt=""></div>
				<div class="col-12 col-sm-2"><img src="resources/images/client03.png" alt=""></div>
				<div class="col-12 col-sm-2"><img src="resources/images/client04.png" alt=""></div>
				<div class="col-12 col-sm-2"><img src="resources/images/client05.png" alt=""></div>
				<div class="col-1 col-sm-1 hidden-sm">&nbsp;</div>
			</div><!-- /row -->
		</div><!-- /container -->
	</div><!-- /slide5 -->
